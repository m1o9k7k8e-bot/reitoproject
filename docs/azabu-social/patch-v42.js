...
(function(){
  ...
  // ---- History: the event itself must be visible in the question. ----
  ...
  // ---- Geography: do not ask the prefecture name. Use the map as context and test linked knowledge. ----
  ...
  // Refresh displayed counts/text after all overrides are installed.
